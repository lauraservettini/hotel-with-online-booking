...
<h1 style="color:#199e59;direction:ltr;font-family:'Roboto Slab', Arial, 'Helvetica Neue', Helvetica, sans-serif;font-size:74px;font-weight:700;letter-spacing:normal;line-height:120%;text-align:left;margin-top:0;margin-bottom:0;">Order confirmation<br/> </h1>
</div>
...
<div class="bee-block bee-block-1 bee-paragraph">
<p><strong>Hello {{ $booking['name'] }}, </strong><br/><strong>Your Request is confirm for order n. {{ $booking['code'] }}. </strong></p>
