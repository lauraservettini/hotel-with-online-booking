                ...
                <div>
                    <div class="card">
                        <div class="card-body p-4">
                            <form action="{{ route('store.blog.post') }}" method="post" enctype="multipart/form-data" class="row g-3">
                                @csrf
                                <div class="col-xl-6">
                                ...
                                <div class="col-xl-6">
                                    ...
                                    <input type="text" name="post_title" class="form-control" id="postTitle" @error('post_title') is-invalid @enderror />
                                        @error('post_title')
                                ...
                                <div >
                                    ...
                                    <textarea name="short_descr" class="form-control" id="shortDescr" rows="3" @error('post_title') is-invalid @enderror ></textarea>
                                        @error('short_descr')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                </div>
                                <div class="mb-3">
                                    ...
                                    <textarea name="long_descr" class="form-control" id="myeditorinstance" rows="3" @error('post_title') is-invalid @enderror ></textarea>
                                        @error('long_descr')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                </div>
