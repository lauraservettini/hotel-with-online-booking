                                ...
                                <div class="billing-details">
                                    ...
                                    <table class="table" style="width: 100%">
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align: right"><p>{{ $nights }} Day/s</p></td>
                                            </tr>
                                            <tr>
                                                <td><p>Total Room</p></td>
                                                <td style="text-align: right"><p>{{ $bookingData['numberOfRooms'] }}</p></td>
                                            </tr>
                                            <tr>
                                                <td><p>Subtotal</p></td>
                                                <td style="text-align: right"><p>{{ $bookingData['numberOfRooms'] * $room->price * $nights }} €</p></td>
                                            </tr>
                                            <tr>
                                                <td><p>Discount</p></td>
                                                <td style="text-align:right"> <p>{{ $room->discount }} %</p></td>
                                            </tr>
                                            <tr>
                                                <td><p>Total</p></td>
                                                <td style="text-align:right"> <p>{{ ($bookingData['numberOfRooms'] * $room->price * $nights) - (($bookingData['numberOfRooms'] * $room->price * $nights) / 100 * $room->discount) }} €</p></td>
                                            </tr>
                                    </table>
