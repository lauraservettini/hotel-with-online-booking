        ...
        <nav class="navbar navbar-expand gap-3">
              ...
              <div class="top-menu ms-auto">
                <ul class="navbar-nav align-items-center gap-1">
                    ...
                    <li class="nav-item dropdown dropdown-large">
                        ...
                        @endphp
                        <a class="nav-link dropdown-toggle dropdown-toggle-nocaret position-relative" href="#" data-bs-toggle="dropdown"><span class="alert-count notification-count">{{ $ncount }}</span>
                        ...
                        <div class="dropdown-menu dropdown-menu-end">
                            <a href="javascript:;">
                                <div class="msg-header">
                                    ...
                                    <p class="msg-header-badge"><span class="notification-count">{{ $ncount }}</span> New</p>
                                </div>
                            </a>
            ...
            <div class="user-box dropdown px-3">
                <a class="d-flex align-items-center nav-link dropdown-toggle gap-3 dropdown-toggle-nocaret" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                    ...
                    <div class="user-info">
                        <p class="user-name mb-0">{{ !empty($profileData->name) ? $profileData->name : ""}}</p>
                        <p class="designattion mb-0">{{ !empty($profileData->email) ? $profileData->email : ""}}</p>
                    </div>
                </a>
...
<script>
    function markNotificationAsRead(notificationId){
        ...
        fetch('/admin/mark-notification-as-read/' + notificationId, {
            method: 'POST',
            headers: {
        ...
        .then(data => {
            elements = document.querySelectorAll('.notification-count');
